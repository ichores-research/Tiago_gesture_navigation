...
class SingleImageAlphaPose():
    ...
    def writeJson(self, final_result, outputpath, form='coco', for_eval=False, save_json=True):
        from alphapose.utils.pPose_nms import write_json
        json_results = write_json(final_result, outputpath, form=form, for_eval=for_eval, save_json=save_json)
